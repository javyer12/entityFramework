...
public class TaskContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        categoriesInit.Add(new Category() { CategoryId = Guid.Parse("e2411a88-eb28-4ea5-a220-85d5e2d4fa7c"), Name = "Entity Framework", Relevance = "50" });
        ...
        modelBuilder.Entity<Category>(category =>
        {
            ...
            category.Property(p => p.Description).IsRequired(false).HasMaxLength(250);
        ...
        taskInit.Add(new Task() { TaskId = Guid.Parse("e2411a88-eb28-4ea5-a220-85d5e2d4fa71"), CategoryId = Guid.Parse("e2411a88-eb28-4ea5-a220-85d5e2d4fa7b"), PriorityTask = Priority.Middle, Title = " Use UseContext", Description = "We need to understand how UseContext works.", DeadLine = DateTime.Now });
        taskInit.Add(new Task() { TaskId = Guid.Parse("e2411a88-eb28-4ea5-a220-85d5e2d4fa72"), CategoryId = Guid.Parse("e2411a88-eb28-4ea5-a220-85d5e2d4fa7a"), PriorityTask = Priority.Under, Title = "Create Interface", Description = "To Create wonderfull interface is essential for us to inhance our skills.", DeadLine = DateTime.Now });
        taskInit.Add(new Task() { TaskId = Guid.Parse("e2411a88-eb28-4ea5-a220-85d5e2d4fa73"), CategoryId = Guid.Parse("e2411a88-eb28-4ea5-a220-85d5e2d4fa7b"), PriorityTask = Priority.High, Title = " Finish EF Course", Description = "Today we have to finish this course.", DeadLine = DateTime.Now });
...
//posible solucion a user constraints
//builder.Entity<User>()
// .HasIndex(u => u.Email)
// .IsUnique();
